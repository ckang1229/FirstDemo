module.exports = function(modules) {
    ...
    var _ErrorCorrectLevel = __webpack_require__(1);
    ...
    exports.default = {
        ...
        watch: {
            "value+size+level+bgColor+fgColor": function valueSizeLevelBgColorFgColor() {
                this.render();
            }
        },
        methods: {
            render: function render() {
                ...
                cells.forEach(function(row, rdx) {
                    row.forEach(function(cell, cdx) {
                        ctx.fillStyle = cell ? _this.fgColor : _this.bgColor;
    ...
    var RSBlock = __webpack_require__(9);
    ...
    module.exports = ' <canvas :style="{height: size, width: size}" :height=size :width=size></canvas> ';
}, function(module, exports, __webpack_require__) {
