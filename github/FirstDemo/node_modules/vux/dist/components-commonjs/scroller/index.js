        ...
        ready: function ready() {
            ...
            if (this.usePulldown) {
                ...
                this.pulldown.on("loading", function(e) {
                    _this.$emit("pulldown:loading", _this.uuid);
                });
            ...
            if (this.usePullup) {
                ...
                this.pullup.on("loading", function(e) {
                    _this.$emit("pullup:loading", _this.uuid);
                });
            ...
            if (this.enableHorizontalSwiping) {
                this._xscroll.on("panstart", function(e) {
                    if (e.direction === 2 || e.direction === 4) {
                        e.preventDefault();
                        if (_this.scrollbarY) {
                            _this._xscroll.userConfig.scrollbarY = false;
                        }
                        _this._xscroll.userConfig.lockY = true;
                    }
                });
                this._xscroll.on("panend", function() {
                    if (_this.scrollbarY) {
                        _this._xscroll.userConfig.scrollbarY = true;
                    }
                    _this._xscroll.userConfig.lockY = false;
                });
            }
