module.exports = function(modules) {
    ...
    var IObject = __webpack_require__(55), defined = __webpack_require__(15);
    ...
    var global = __webpack_require__(1), core = __webpack_require__(9), ctx = __webpack_require__(52), hide = __webpack_require__(5), PROTOTYPE = "prototype";
    ...
    var anObject = __webpack_require__(8), dPs = __webpack_require__(61), enumBugKeys = __webpack_require__(16), IE_PROTO = __webpack_require__(21)("IE_PROTO"), Empty = function() {}, PROTOTYPE = "prototype";
    ...
    var has = __webpack_require__(2), toIObject = __webpack_require__(3), arrayIndexOf = __webpack_require__(51)(false), IE_PROTO = __webpack_require__(21)("IE_PROTO");
    ...
    exports.default = {
        ...
        destroyed: function destroyed() {
            ...
            if (this.template === 1) {
                var progress = document.querySelector("#mprogress1");
    ...
    (function(root, factory) {
        ...
        var cacheStore = {};
        var Mprogress = function Mprogress(opt) {
            var options = _utils2.default.extend(opt, SETTINGS);
        ...
        var MProgress = function MProgress(options) {
        ...
        MProgress.prototype = {
            ...
            start: function start() {
                ...
                if (this._isBufferStyle() && !this.bufferStatus) {
                    ...
                    _utils2.default.hideEl(bar);
                    _utils2.default.hideEl(dashed);
                    this.setBuffer(0);
                    setTimeout(function() {
                        _utils2.default.showEl(dashed);
                        _utils2.default.showEl(bar);
                ...
                if (this._isIndeterminateStyle()) {
                    ...
                    _utils2.default.setcss(progress, {
                        transition: "none",
                        opacity: 1
                    });
                ...
                if (this._isQueryStyle()) {
                    if (this._isRendered()) {
                        var bar = progress.querySelector(this._getCurrSelector());
                        _utils2.default.addClass(bar, "end");
                        setTimeout(function() {
                            that._remove();
            ...
            set: function set(n) {
                n = _utils2.default.clamp(n, this.options.minimum, 1);
                this.status = n === 1 ? null : n;
                this._setProgress(this._getCurrSelector(), n);
                return this;
            },
            setBuffer: function setBuffer(n) {
                n = _utils2.default.clamp(n, this.options.minimum, 1);
            ...
            _trickle: function _trickle() {
                return this.inc(Math.random() * this.options.trickleRate);
            },
            _render: function _render(noFromStart) {
                if (this._isRendered()) {
                ...
                if (!this._isIndeterminateStyle() && !this._isQueryStyle()) {
                    ...
                    var bar = progress.querySelector(this._getCurrSelector());
                    var perc = fromStart ? "-100" : _utils2.default.toBarPerc(this.status || 0);
                    _utils2.default.setcss(bar, {
                        transition: "all 0 linear",
                        transform: "translate3d(" + perc + "%,0,0)"
                    });
                    if (this._isBufferStyle()) {
                        var buffer = progress.querySelector(SELECTOR_BUFFER);
                        var bufferPerc = fromStart ? "-100" : _utils2.default.toBarPerc(this.bufferStatus || 0);
                        _utils2.default.setcss(buffer, {
                            transition: "all 0 linear",
                ...
                if (MParent !== document.body) {
                    _utils2.default.addClass(MParent, "mprogress-custom-parent");
                }
            ...
            _remove: function _remove() {
                ...
                var MParent = document.querySelector(this.options.parent);
                if (MParent !== document.body) {
                    _utils2.default.removeClass(MParent, "mprogress-custom-parent");
                }
                ...
                if (progress) {
                    this.status = null;
                    this.bufferStatus = null;
                    _utils2.default.removeElement(progress);
                }
            },
            _setProgress: function _setProgress(barSelector, n) {
                if (this.stop) {
                    return;
                }
                var progress = this._render();
                ...
                _utils2.default.queue(function(next) {
                    if (that.options.positionUsing === "") that.options.positionUsing = that._getPositioningCSS();
                    _utils2.default.setcss(bar, that._barPositionCSS(n, speed, ease));
                    if (n === 1) {
                        _utils2.default.setcss(progress, {
                            transition: "none",
                            opacity: 1
            ...
            _getCurrSelector: function _getCurrSelector() {
            ...
            _getRandomNum: function _getRandomNum(n, amount) {
                if (typeof amount !== "number") {
                    amount = (1 - n) * _utils2.default.clamp(Math.random() * n, .1, .95);
                }
                n = _utils2.default.clamp(n + amount, 0, .994);
                return n;
            },
            _isRendered: function _isRendered() {
                return !!this._getRenderedId();
            },
            _getRenderedId: function _getRenderedId(getId) {
                var tplType = this._getCurrTplId();
            ...
            _isBufferStyle: function _isBufferStyle() {
                return this._getCurrTplId() === 2;
            },
            _isIndeterminateStyle: function _isIndeterminateStyle() {
                return this._getCurrTplId() === 3;
            },
            _isQueryStyle: function _isQueryStyle() {
                return this._getCurrTplId() === 4;
            },
            _getCurrTplId: function _getCurrTplId() {
            ...
            _getCurrTemplate: function _getCurrTemplate() {
                var tplType = this.options.template || 1;
            ...
            _getPositioningCSS: function _getPositioningCSS() {
            ...
            _barPositionCSS: function _barPositionCSS(n, speed, ease) {
                var barCSS;
                if (this.options.positionUsing === "translate3d") {
                    barCSS = {
                        transform: "translate3d(" + _utils2.default.toBarPerc(n) + "%,0,0)"
                    };
                } else if (this.options.positionUsing === "translate") {
                    barCSS = {
                        transform: "translate(" + _utils2.default.toBarPerc(n) + "%,0)"
                    };
                } else {
                    barCSS = {
                        "margin-left": _utils2.default.toBarPerc(n) + "%"
                    };
                }
    ...
    var Utils = {
        extend: function extend(newObj, targetObj) {
            targetObj = JSON.parse((0, _stringify2.default)(targetObj));
    ...
    var _mixin_uuid = __webpack_require__(41);
    ...
    var toIObject = __webpack_require__(3), toLength = __webpack_require__(67), toIndex = __webpack_require__(66);
    ...
    var has = __webpack_require__(2), toObject = __webpack_require__(68), IE_PROTO = __webpack_require__(21)("IE_PROTO"), ObjectProto = Object.prototype;
    ...
    "use strict";
    var addToUnscopables = __webpack_require__(50), step = __webpack_require__(58), Iterators = __webpack_require__(17), toIObject = __webpack_require__(3);
    ...
    "use strict";
    var global = __webpack_require__(1), has = __webpack_require__(2), DESCRIPTORS = __webpack_require__(4), $export = __webpack_require__(29), redefine = __webpack_require__(36), META = __webpack_require__(60).KEY, $fails = __webpack_require__(10), shared = __webpack_require__(22), setToStringTag = __webpack_require__(20), uid = __webpack_require__(14), wks = __webpack_require__(7), wksExt = __webpack_require__(26), wksDefine = __webpack_require__(25), keyOf = __webpack_require__(59), enumKeys = __webpack_require__(53), isArray = __webpack_require__(56), anObject = __webpack_require__(8), toIObject = __webpack_require__(3), toPrimitive = __webpack_require__(24), createDesc = __webpack_require__(13), _create = __webpack_require__(32), gOPNExt = __webpack_require__(63), $GOPD = __webpack_require__(62), $DP = __webpack_require__(6), $keys = __webpack_require__(12), gOPD = $GOPD.f, dP = $DP.f, gOPN = gOPNExt.f, $Symbol = global.Symbol, $JSON = global.JSON, _stringify = $JSON && $JSON.stringify, PROTOTYPE = "prototype", HIDDEN = wks("_hidden"), TO_PRIMITIVE = wks("toPrimitive"), isEnum = {}.propertyIsEnumerable, SymbolRegistry = shared("symbol-registry"), AllSymbols = shared("symbols"), OPSymbols = shared("op-symbols"), ObjectProto = Object[PROTOTYPE], USE_NATIVE = typeof $Symbol == "function", QObject = global.QObject;
    ...
    module.exports = ' <div :id="\'vux-progress-\' + uuid" class=vux-progress v-if="template > 0"></div> <div class=weui_progress v-if="template === 0"> <div class=weui_progress_bar> <div class="weui_progress_inner_bar js_progress" :style="{width: percent + \'%\'}"></div> </div> <a href=javascript:; class=weui_progress_opr> <i class=weui_icon_cancel @click=cancel></i> </a> </div> ';
}, function(module, exports, __webpack_require__) {
